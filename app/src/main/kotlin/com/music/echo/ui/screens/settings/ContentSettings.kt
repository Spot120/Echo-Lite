...
highlightKey: String? = null) {
    ...
    val (showCuratedPlaylists, onShowCuratedPlaylistsChange) = rememberPreference(
        key = ShowCuratedPlaylistsKey,
        defaultValue = true
    )
    ...
    isHighlighted = (highlightKey == stringResource(R.string.randomize_home_order)),
                ...
                Material3SettingsItem(
    isHighlighted = (highlightKey == stringResource(R.string.show_curated_playlists)),
                    icon = painterResource(R.drawable.trending_up),
                    title = { Text(stringResource(R.string.show_curated_playlists)) },
                    description = { Text(stringResource(R.string.show_curated_playlists_desc)) },
                    trailingContent = {
                        Switch(
                            checked = showCuratedPlaylists,
                            onCheckedChange = onShowCuratedPlaylistsChange,
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                                        id = if (showCuratedPlaylists) R.drawable.check else R.drawable.close
                                    ),
                                    contentDescription = null,
                                    modifier = Modifier.size(SwitchDefaults.IconSize)
                                )
                    ...
                    onClick = { onShowCuratedPlaylistsChange(!showCuratedPlaylists) }
                ),
                Material3SettingsItem(
