...
fun UpdateSettings(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    description = {
                        if (isUpdateAvailable) {
                            ...
                            Text("If you update, Echo Lite may get overwritten by the original Echo Music app.")
                        }
                    },
                    onClick = {
                        Toast.makeText(context, "Updates are disabled for Echo Lite to prevent overwriting.", Toast.LENGTH_LONG).show()
                    }
                ),
                Material3SettingsItem(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.auto_update_check)),
                    ...
                    description = { Text("Auto update checks are disabled for Echo Lite.") },
                    trailingContent = {
                        Switch(
                            checked = false,
                            enabled = false,
                    ...
                    onClick = { /* Disabled for Echo Lite */ }
                ),
